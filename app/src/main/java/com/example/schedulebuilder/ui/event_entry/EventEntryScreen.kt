    ...
    if (openAlertDialog.value) {
        AlertDialogExample(
            ...
            onConfirmation = {
                ...
                navigateBack() // Actually close the screen
            },
...
//            value = scheduleEventDetails.subject.fullDisplayName,
            onValueChange = {},
            readOnly = true,
...
fun StartHourSelection(
    ...
    Column(modifier = modifier) {
        ...
        Box {
            OutlinedTextField(
                value = "${scheduleEventDetails.startHour}:00",
                onValueChange = {},
                readOnly = true,
                trailingIcon = { Icon(Icons.Default.ArrowDropDown, "dropdown") },
                modifier = Modifier
...
fun EndHourSelection(
    ...
    Column(modifier = modifier) {
        ...
        Box {
            OutlinedTextField(
                value = "${scheduleEventDetails.endHour}:00",
                onValueChange = {},
                readOnly = true,
                trailingIcon = { Icon(Icons.Default.ArrowDropDown, "dropdown") },
                modifier = Modifier
